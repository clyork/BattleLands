...
class Monster:
    ...
    bandit_list_rank_1 = [
        ...
        {'name': 'Bandit Mage', 'hp': '9', 'df': '0', 'weapon': 'basic staff', 'magic': 'fireball, thunder, gust',
         'gold': '6'},
    ]
    bandit_list_rank_2 = [
        ...
        {'name': 'Bandit Wizard', 'hp': '15', 'df': '0', 'weapon': 'basic staff',
         'magic': 'fireball, thunder, gust, chain lightning', 'gold': '14'},
    ]
    bandit_list_rank_3 = [
